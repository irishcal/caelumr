...
const Index: React.FC = () => {
  return <Layout currentPage="home">
      <section className="section prose-section">
        <h1 className="text-4xl mb-6 leading-tight font-sans md:text-5xl bg-gradient-to-r from-primary to-muted-foreground bg-clip-text text-transparent">Hi, I'm Caelum Rosenkranz, a London based GTM strategist and operator.</h1>
