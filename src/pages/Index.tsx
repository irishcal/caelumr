    ...
    <Layout currentPage="home">
      <div className="relative">
        <section className="section prose-section">
          <h1 className="text-3xl mb-6 leading-tight md:text-4xl bg-gradient-to-r from-primary to-muted-foreground bg-clip-text text-transparent px-[3px] font-normal" style={{ fontFamily: 'Manrope, sans-serif' }}>Hi there! I'm Caelum Rosenkranz, a London based GTM strategist and operator.</h1>
