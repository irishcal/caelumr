...
const Testimonials: React.FC = () => {
  return <Layout currentPage="testimonials">
      <section className="py-8">
        <h1 className="text-3xl md:text-4xl font-medium mb-8">Testimonials</h1>
        <p className="text-lg text-muted-foreground mb-12">What colleagues and clients have to say. </p>
        
        <div className="grid gap-8">
          {testimonials.map(testimonial => <Card key={testimonial.id} className="bg-secondary/30">
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  {testimonial.quote.split("\n\n").map((paragraph, idx) => <p key={idx} className="text-foreground leading-relaxed">
                      {paragraph}
                    </p>)}
                </div>
